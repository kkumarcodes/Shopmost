  ...
  await Promise.all(
    routes.map(async (route) => {
      ...
      const defaultTailwindConfig = route.isAdmin
        ? require('@shopmost/shopmost/src/modules/cms/services/tailwind.admin.config.js')
        : require('@shopmost/shopmost/src/modules/cms/services/tailwind.frontStore.config.js');
