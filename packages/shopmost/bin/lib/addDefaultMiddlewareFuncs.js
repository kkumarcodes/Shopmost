...
const {
  createConfigClient
} = require('@shopmost/shopmost/src/lib/webpack/dev/createConfigClient');
...
const publicStatic = require('@shopmost/shopmost/src/lib/middlewares/publicStatic');
const themePublicStatic = require('@shopmost/shopmost/src/lib/middlewares/themePublicStatic');
