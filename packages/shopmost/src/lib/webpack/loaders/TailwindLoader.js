...
module.exports = exports = function TailwindLoader(c) {
  ...
  mergedTailwindConfig.content = [
    ...
    // All file in packages/shopmost/src and name is capitalized
    join(CONSTANTS.ROOTPATH, 'packages', 'shopmost', 'src', '**', '[A-Z]*.jsx'),
    // All file in node_modules/@shopmost/shopmost/src and name is capitalized
    join(
      CONSTANTS.ROOTPATH,
      'node_modules',
      '@shopmost',
