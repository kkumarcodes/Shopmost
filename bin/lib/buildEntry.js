...
} = require('@shopmost/shopmost/src/lib/componee/getComponentsByRoute');
...
const {
  parseGraphql
} = require('@shopmost/shopmost/src/lib/webpack/util/parseGraphql');
...
module.exports.buildEntry = async function buildEntry(
  ...
  await Promise.all(
    routes.map(async (route) => {
      ...
      import Area from '@shopmost/shopmost/src/components/common/Area';
      import Hydrate from '@shopmost/shopmost/src/components/common/react/client/${
      ...
      if (!clientOnly) {
        ...
        contentServer += '\r\n';
        contentServer += `import Area from '@shopmost/shopmost/src/components/common/Area';`;
        contentServer += '\r\n';
